...
public class ViewNavigator extends Navigator{
    ...
    private static final ApplicationViewType ERROR_VIEW = ApplicationViewType.REPORTS;
    private ViewProvider errorViewProvider; 
     
	public ViewNavigator(final ComponentContainer container) {
	 ...
	 private void initViewChangeListener() {
	        addViewChangeListener(new ViewChangeListener() {
	            ...
	            public void afterViewChange(final ViewChangeEvent event) {
	                /*ApplicationViewType view = ApplicationViewType.getByViewName(event
	                        .getViewName());
